...
uint32_t VkUtil::find_memory_type(VkContext& context, uint32_t typeFilter, VkMemoryPropertyFlags properties)
{
...
void VkUtil::create_vk_context(std::vector<const char*>& extensions, uint32_t gpu_index, VkContext& context)
{
	VkResult err;
	...
	// Select GPU
	{
        ...
        std::cout << "Available gpus (selected one is in green):" << std::endl;
        if (gpu_index >= gpu_count) gpu_index = gpu_count - 1;
...
void VkUtil::destroy_vk_context(VkContext& context)
{
...
void VkUtil::create_compute_pipeline(VkContext& context, VkShaderModule& shaderModule, std::vector<VkDescriptorSetLayout> descriptorLayouts, VkPipelineLayout* pipelineLayout, VkPipeline* pipeline)
{
    VkResult err;
...
void VkUtil::create_compute_pipeline(VkContext& context, VkShaderModule& shaderModule, std::vector<VkDescriptorSetLayout> descriptorLayouts, std::vector<VkPushConstantRange>& push_constants, VkPipelineLayout* pipelineLayout, VkPipeline* pipeline)
{
    VkResult err;
...
void VkUtil::create_descriptor_set_layout(VkContext& context, const std::vector<VkDescriptorSetLayoutBinding>& bindings, VkDescriptorSetLayout* descriptorSetLayout)
{
    VkResult err;
...
void VkUtil::create_descriptor_setLayout_partially_bound(VkContext& context, const std::vector<VkDescriptorSetLayoutBinding>& bindings, const std::vector<bool>& enableValidation, VkDescriptorSetLayout* descriptorSetLayout)
{
    VkResult err;
...
void VkUtil::create_descriptor_sets(VkContext& context, const std::vector<VkDescriptorSetLayout>& layouts, VkDescriptorSet* descriptorSetArray)
{
    VkResult err;
...
void VkUtil::update_descriptor_set(VkContext& context, VkBuffer buffer, uint32_t size, uint32_t binding, VkDescriptorType descriptorType, VkDescriptorSet descriptorSet)
{
...
void VkUtil::update_image_descriptor_set(VkContext& context, VkSampler sampler, VkImageView imageView, VkImageLayout imageLayout, VkDescriptorType imageType, uint32_t binding, VkDescriptorSet descriptorSet)
{
...
void VkUtil::create_image(VkContext& context, uint32_t width, uint32_t height, VkFormat imageFormat, VkImageUsageFlags usageFlags, VkImage* image)
{
    VkResult err;
...
void VkUtil::create_image_array(VkContext& context, uint32_t width, uint32_t height, uint32_t array_count, VkFormat imageFormat, VkImageUsageFlags usageFlags, VkImage* image)
{
    VkResult err;
...
void VkUtil::create_image_view_array(VkContext& context, VkImage image, VkFormat imageFormat, uint32_t mipLevelCount, uint32_t array_count, VkImageAspectFlags aspectMask, VkImageView* imageView)
{
    VkResult err;
...
void VkUtil::create_buffer(VkContext& context, uint32_t size, VkBufferUsageFlags usage, VkBuffer* buffer)
{
    VkResult err;
...
void VkUtil::create_image_sampler(VkContext& context, VkSamplerAddressMode adressMode, VkFilter filter, uint16_t maxAnisotropy, uint16_t mipLevels, VkSampler* sampler)
{
    VkResult err;
...
void VkUtil::create_command_buffer(VkContext& context, VkCommandBuffer* commandBuffer)
{
    VkResult err;
...
void VkUtil::commit_command_buffer(VkContext& context, VkCommandBuffer commandBuffer)
{
    VkResult err;
...
void VkUtil::execute_command_buffer(VkContext& context, VkCommandBuffer commandBuffer)
{
    VkSubmitInfo submitInfo = {};
    submitInfo.sType = VK_STRUCTURE_TYPE_SUBMIT_INFO;
    submitInfo.signalSemaphoreCount = 0;
    ...
    VkResult err = vkQueueSubmit(context.queue, 1, &submitInfo, VK_NULL_HANDLE);
    check_vk_result(err);
}
...
void VkUtil::upload_data(VkContext& context, VkDeviceMemory memory, uint32_t offset, uint32_t byteSize, void* data)
{
    void* d;
...
void VkUtil::download_data(VkContext& context, VkDeviceMemory memory, uint32_t offset, uint32_t byteSize, void* data)
{
    void* d;
    vkMapMemory(context.device, memory, offset, byteSize, 0, &d);
...
void VkUtil::upload_image_data(VkContext& context, VkImage image, VkImageLayout imageLayout, VkFormat imageFormat, uint32_t x, uint32_t y, uint32_t z, uint32_t array_layer, void* data, uint32_t byteSize)
{
...
void VkUtil::download_image_data(VkContext& context, VkImage image, VkImageLayout layout, VkFormat imageFormat, uint32_t x, uint32_t y, uint32_t z, uint32_t array_layer, void* data, uint32_t byteSize)
{
    VkBuffer stagingBuffer;
    VkDeviceMemory stagingMemory;
...
void VkUtil::pipeline_barrier(VkCommandBuffer commandBuffer, VkPipelineStageFlags stage_flags)
{
    vkCmdPipelineBarrier(commandBuffer, stage_flags, stage_flags, 0, 0, nullptr, 0, nullptr, 0, nullptr);
}

void VkUtil::create_image_view(VkContext& context, VkImage image, VkFormat imageFormat, uint32_t mipLevelCount, VkImageAspectFlags aspectMask, VkImageView* imageView)
{
    VkResult err;
...
VkShaderModule VkUtil::create_shader_module(VkContext& context, const std::vector<char>& byteArr)
{
